...
Causal refers to the fact that the triangulations generally span two adjacent timeslices. This is a $2$-face in the timelike direction. For $d=4$ dimensions, we separate simplices into timelike and spacelike simplices, and in what follows, consider the extrinsic curvature of the spacelike simplices to be the equivalent to the continuum mass and stress-energy.
