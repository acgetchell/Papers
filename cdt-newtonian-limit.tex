...
Why is QG important? Why is QG hard? What is the CDT approach to QG? What are CDTs successes? What are CDT's problems? How does this paper solve one of its problems?
...
What is elementary flatness? What is a conical singularity? What is intrinsic curvature? What is extrinsic curvature? Why does a conical singularity give us Newton's law?
...
Discuss triangulations. Discuss dynamical triangulations. Discuss Regge calculus. Discuss getting the Einstein tensor in Regge calculus. Discuss getting mass from CDT insertions. Discuss ergodic moves. 
...
Discuss Computational Geometry. Discuss the CDT algorithm. Discuss the algorithm for getting mass. Discuss algorithm for getting stress-energy. Discuss other geometrical algorithms.
...
Discuss any preliminary results.

\section{Conclusion}

Discuss further work. Thank colleagues.
