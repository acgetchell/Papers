...
\end{equation}
\begin{equation}
\partial_{r}\nu=r\left(\partial^{2}_{r}\nu+\partial^{2}_{z}\nu+2\left(\partial_{r}\lambda\right)^{2}\right)
\end{equation}
\begin{equation}
\partial_{z}\nu=2r\partial_{r}\lambda\partial_{z}\lambda
\end{equation}
\begin{equation}
\partial^{2}_{r}\nu+\partial^{2}_{z}\nu+\left(\partial_{r}\lambda\right)^{2}+\left(\partial_{z}\lambda\right)^{2}=0
\end{equation}
...
\begin{equation}
\lambda (r,z)=\sum^{\infty}_{m=0}[A_{m}J_{m}\left(kr\right)+B_{m}N_{m}\left(kr\right)][C_{m}\sinh(kr)+D_{m}\cosh(kr)]
\end{equation}
