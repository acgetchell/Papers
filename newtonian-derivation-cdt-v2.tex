...
We have a loose end in assuming that \Cref{eq:h-limit} holds. To address if we are justified in applying \Cref{eq:h-limit}, we should check to see if our solution reduces to the Schwarszchild solution for $r\rightarrow\infty$.
